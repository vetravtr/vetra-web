...
`;var B=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let C=class extends t.LitElement{constructor(){super(),this.unsubscribe=[],this.explorerWallets=e.ApiController.state.explorerWallets,this.connections=n.ConnectionController.state.connections,this.connectorImages=u.AssetController.state.connectorImages,this.loadingTelegram=!1,this.unsubscribe.push(n.ConnectionController.subscribeKey("connections",a=>this.connections=a),u.AssetController.subscribeKey("connectorImages",a=>this.connectorImages=a),e.ApiController.subscribeKey("explorerFilteredWallets",a=>{this.explorerWallets=a?.length?a:e.ApiController.state.explorerWallets}),e.ApiController.subscribeKey("explorerWallets",a=>{this.explorerWallets?.length||(this.explorerWallets=a)})),f.CoreHelperUtil.isTelegram()&&f.CoreHelperUtil.isIos()&&(this.loadingTelegram=!n.ConnectionController.state.wcUri,this.unsubscribe.push(n.ConnectionController.subscribeKey("wcUri",a=>this.loadingTelegram=!a)))}disconnectedCallback(){this.unsubscribe.forEach(a=>a())}render(){return c.html`
    ...
    `}onClickWallet(a){let b=q.RouterController.state.data?.redirectView,c=w.ChainController.state.activeChain;if("featured"===a.subtype)return void o.ConnectorController.selectWalletConnector(a.wallet);if("recent"===a.subtype){if(this.loadingTelegram)return;o.ConnectorController.selectWalletConnector(a.wallet);return}if("custom"===a.subtype){if(this.loadingTelegram)return;q.RouterController.push("ConnectingWalletConnect",{wallet:a.wallet,redirectView:b});return}if(this.loadingTelegram)return;let d=c?o.ConnectorController.getConnector({id:a.wallet.id,namespace:c}):void 0;d?q.RouterController.push("ConnectingExternal",{connector:d,redirectView:b}):q.RouterController.push("ConnectingWalletConnect",{wallet:a.wallet,redirectView:b})}};C.styles=A,B([(0,k.property)({type:Number})],C.prototype,"tabIdx",void 0),B([(0,d.state)()],C.prototype,"explorerWallets",void 0),B([(0,d.state)()],C.prototype,"connections",void 0),B([(0,d.state)()],C.prototype,"connectorImages",void 0),B([(0,d.state)()],C.prototype,"loadingTelegram",void 0),C=B([(0,i.customElement)("w3m-connector-list")],C);var D=b,E=a.i(16269),F=a.i(55010),G=a.i(94074),H=a.i(42606),I=a.i(96441),J=a.i(66116),K=b,L=b,M=a.i(7117),N=b;a.i(3365),a.i(60245);let O=z.css`
  :host {
    flex: 1;
    height: 100%;
  }
...
`;var P=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let Q={lg:"lg-regular",md:"md-regular",sm:"sm-regular"},R={lg:"md",md:"sm",sm:"sm"},S=class extends N.LitElement{constructor(){super(...arguments),this.icon="mobile",this.size="md",this.label="",this.active=!1}render(){return c.html`
      <button data-active=${this.active}>
        ${this.icon?c.html`<wui-icon size=${R[this.size]} name=${this.icon}></wui-icon>`:""}
        <wui-text variant=${Q[this.size]}> ${this.label} </wui-text>
      </button>
    `}};S.styles=[M.resetStyles,M.elementStyles,O],P([(0,k.property)()],S.prototype,"icon",void 0),P([(0,k.property)()],S.prototype,"size",void 0),P([(0,k.property)()],S.prototype,"label",void 0),P([(0,k.property)({type:Boolean})],S.prototype,"active",void 0),S=P([(0,i.customElement)("wui-tab-item")],S);let T=z.css`
  :host {
    display: inline-flex;
    align-items: center;
...
`;var U=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let V=class extends L.LitElement{constructor(){super(...arguments),this.tabs=[],this.onTabChange=()=>null,this.size="md",this.activeTab=0}render(){return this.dataset.size=this.size,this.tabs.map((a,b)=>{let d=b===this.activeTab;return c.html`
        <wui-tab-item
        ...
        ></wui-tab-item>
      `})}onTabClick(a){this.activeTab=a,this.onTabChange(a)}};V.styles=[M.resetStyles,M.elementStyles,T],U([(0,k.property)({type:Array})],V.prototype,"tabs",void 0),U([(0,k.property)()],V.prototype,"onTabChange",void 0),U([(0,k.property)()],V.prototype,"size",void 0),U([(0,d.state)()],V.prototype,"activeTab",void 0),V=U([(0,i.customElement)("wui-tabs")],V);var W=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let X=class extends K.LitElement{constructor(){super(...arguments),this.platformTabs=[],this.unsubscribe=[],this.platforms=[],this.onSelectPlatfrom=void 0}disconnectCallback(){this.unsubscribe.forEach(a=>a())}render(){let a=this.generateTabs();return c.html`
      <wui-flex justifyContent="center" .padding=${["0","0","4","0"]}>
        <wui-tabs .tabs=${a} .onTabChange=${this.onTabChange.bind(this)}></wui-tabs>
      </wui-flex>
    `}generateTabs(){let a=this.platforms.map(a=>{if("browser"===a)return{label:"Browser",icon:"extension",platform:"browser"};if("mobile"===a)return{label:"Mobile",icon:"mobile",platform:"mobile"};if("qrcode"===a)return{label:"Mobile",icon:"mobile",platform:"qrcode"};if("web"===a)return{label:"Webapp",icon:"browser",platform:"web"};if("desktop"===a)return{label:"Desktop",icon:"desktop",platform:"desktop"};return{label:"Browser",icon:"extension",platform:"unsupported"}});return this.platformTabs=a.map(({platform:a})=>a),a}onTabChange(a){let b=this.platformTabs[a];b&&this.onSelectPlatfrom?.(b)}};W([(0,k.property)({type:Array})],X.prototype,"platforms",void 0),W([(0,k.property)()],X.prototype,"onSelectPlatfrom",void 0),X=W([(0,i.customElement)("w3m-connecting-header")],X);var Y=b,Z=a.i(82132);a.i(56259),a.i(26404),a.i(87743),a.i(42414);var $=b;let _=z.css`
  :host {
    display: block;
    width: 100px;
    height: 100px;
...
`;var aa=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let ab=class extends $.LitElement{constructor(){super(...arguments),this.radius=36}render(){return this.svgLoaderTemplate()}svgLoaderTemplate(){let a=this.radius>50?50:this.radius,b=36-a;return c.html`
    ...
    `}};ab.styles=[M.resetStyles,_],aa([(0,k.property)({type:Number})],ab.prototype,"radius",void 0),ab=aa([(0,i.customElement)("wui-loading-thumbnail")],ab),a.i(83254),a.i(93582);var ac=b,ad=a.i(48293),ae=b;a.i(18288),a.i(16445);let af=z.css`
  wui-flex {
    width: 100%;
    height: 52px;
    box-sizing: border-box;
...
`;var ag=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let ah=class extends ae.LitElement{constructor(){super(...arguments),this.disabled=!1,this.label="",this.buttonLabel=""}render(){return c.html`
    ...
    `}};ah.styles=[M.resetStyles,M.elementStyles,af],ag([(0,k.property)({type:Boolean})],ah.prototype,"disabled",void 0),ag([(0,k.property)()],ah.prototype,"label",void 0),ag([(0,k.property)()],ah.prototype,"buttonLabel",void 0),ah=ag([(0,i.customElement)("wui-cta-button")],ah);let ai=z.css`
  :host {
    display: block;
    padding: 0 ${({spacing:a})=>a["5"]} ${({spacing:a})=>a["5"]};
  }
`;var aj=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let ak=class extends ac.LitElement{constructor(){super(...arguments),this.wallet=void 0}render(){if(!this.wallet)return this.style.display="none",null;let{name:a,app_store:b,play_store:d,chrome_store:e,homepage:g}=this.wallet,h=f.CoreHelperUtil.isMobile(),i=f.CoreHelperUtil.isIos(),j=f.CoreHelperUtil.isAndroid(),k=[b,d,g,e].filter(Boolean).length>1,l=ad.UiHelperUtil.getTruncateString({string:a,charsStart:12,charsEnd:0,truncate:"end"});return k&&!h?c.html`
        <wui-cta-button
          label=${`Don't have ${l}?`}
          buttonLabel="Get"
...
`;var am=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};class an extends Y.LitElement{constructor(){super(),this.wallet=q.RouterController.state.data?.wallet,this.connector=q.RouterController.state.data?.connector,this.timeout=void 0,this.secondaryBtnIcon="refresh",this.onConnect=void 0,this.onRender=void 0,this.onAutoConnect=void 0,this.isWalletConnect=!0,this.unsubscribe=[],this.imageSrc=v.AssetUtil.getConnectorImage(this.connector)??v.AssetUtil.getWalletImage(this.wallet),this.name=this.wallet?.name??this.connector?.name??"Wallet",this.isRetrying=!1,this.uri=n.ConnectionController.state.wcUri,this.error=n.ConnectionController.state.wcError,this.ready=!1,this.showRetry=!1,this.label=void 0,this.secondaryBtnLabel="Try again",this.secondaryLabel="Accept connection request in the wallet",this.isLoading=!1,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(n.ConnectionController.subscribeKey("wcUri",a=>{this.uri=a,this.isRetrying&&this.onRetry&&(this.isRetrying=!1,this.onConnect?.())}),n.ConnectionController.subscribeKey("wcError",a=>this.error=a)),(f.CoreHelperUtil.isTelegram()||f.CoreHelperUtil.isSafari())&&f.CoreHelperUtil.isIos()&&n.ConnectionController.state.wcUri&&this.onConnect?.()}firstUpdated(){this.onAutoConnect?.(),this.showRetry=!this.onAutoConnect}disconnectedCallback(){this.unsubscribe.forEach(a=>a()),n.ConnectionController.setWcError(!1),clearTimeout(this.timeout)}render(){this.onRender?.(),this.onShowRetry();let a=this.error?"Connection can be declined if a previous request is still active":this.secondaryLabel,b="";return this.label?b=this.label:(b=`Continue in ${this.name}`,this.error&&(b="Connection declined")),c.html`
    ...
    `}onShowRetry(){if(this.error&&!this.showRetry){this.showRetry=!0;let a=this.shadowRoot?.querySelector("wui-button");a?.animate([{opacity:0},{opacity:1}],{fill:"forwards",easing:"ease"})}}onTryAgain(){n.ConnectionController.setWcError(!1),this.onRetry?(this.isRetrying=!0,this.onRetry?.()):this.onConnect?.()}loaderTemplate(){let a=Z.ThemeController.state.themeVariables["--w3m-border-radius-master"],b=a?parseInt(a.replace("px",""),10):4;return c.html`<wui-loading-thumbnail radius=${9*b}></wui-loading-thumbnail>`}onCopyUri(){try{this.uri&&(f.CoreHelperUtil.copyToClopboard(this.uri),I.SnackController.showSuccess("Link copied"))}catch{I.SnackController.showError("Failed to copy")}}}an.styles=al,am([(0,d.state)()],an.prototype,"isRetrying",void 0),am([(0,d.state)()],an.prototype,"uri",void 0),am([(0,d.state)()],an.prototype,"error",void 0),am([(0,d.state)()],an.prototype,"ready",void 0),am([(0,d.state)()],an.prototype,"showRetry",void 0),am([(0,d.state)()],an.prototype,"label",void 0),am([(0,d.state)()],an.prototype,"secondaryBtnLabel",void 0),am([(0,d.state)()],an.prototype,"secondaryLabel",void 0),am([(0,d.state)()],an.prototype,"isLoading",void 0),am([(0,k.property)({type:Boolean})],an.prototype,"isMobile",void 0),am([(0,k.property)()],an.prototype,"onRetry",void 0);let ao=class extends an{constructor(){if(super(),!this.wallet)throw Error("w3m-connecting-wc-browser: No wallet provided");this.onConnect=this.onConnectProxy.bind(this),this.onAutoConnect=this.onConnectProxy.bind(this),p.EventsController.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"browser",displayIndex:this.wallet?.display_index,walletRank:this.wallet.order,view:q.RouterController.state.view}})}async onConnectProxy(){try{this.error=!1;let{connectors:a}=o.ConnectorController.state,b=a.find(a=>"ANNOUNCED"===a.type&&a.info?.rdns===this.wallet?.rdns||"INJECTED"===a.type||a.name===this.wallet?.name);if(b)await n.ConnectionController.connectExternal(b,b.chain);else throw Error("w3m-connecting-wc-browser: No connector found");H.ModalController.close()}catch(a){a instanceof F.AppKitError&&a.originalName===E.ErrorUtil.PROVIDER_RPC_ERROR_NAME.USER_REJECTED_REQUEST?p.EventsController.sendEvent({type:"track",event:"USER_REJECTED",properties:{message:a.message}}):p.EventsController.sendEvent({type:"track",event:"CONNECT_ERROR",properties:{message:a?.message??"Unknown"}}),this.error=!0}}};ao=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g}([(0,i.customElement)("w3m-connecting-wc-browser")],ao);let ap=class extends an{constructor(){if(super(),!this.wallet)throw Error("w3m-connecting-wc-desktop: No wallet provided");this.onConnect=this.onConnectProxy.bind(this),this.onRender=this.onRenderProxy.bind(this),p.EventsController.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"desktop",displayIndex:this.wallet?.display_index,walletRank:this.wallet.order,view:q.RouterController.state.view}})}onRenderProxy(){!this.ready&&this.uri&&(this.ready=!0,this.onConnect?.())}onConnectProxy(){if(this.wallet?.desktop_link&&this.uri)try{this.error=!1;let{desktop_link:a,name:b}=this.wallet,{redirect:c,href:d}=f.CoreHelperUtil.formatNativeUrl(a,this.uri);n.ConnectionController.setWcLinking({name:b,href:d}),n.ConnectionController.setRecentWallet(this.wallet),f.CoreHelperUtil.openHref(c,"_blank")}catch{this.error=!0}}};ap=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g}([(0,i.customElement)("w3m-connecting-wc-desktop")],ap);var aq=a.i(75064),ar=a.i(83248),as=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let at=class extends an{constructor(){if(super(),this.btnLabelTimeout=void 0,this.redirectDeeplink=void 0,this.redirectUniversalLink=void 0,this.target=void 0,this.preferUniversalLinks=g.OptionsController.state.experimental_preferUniversalLinks,this.isLoading=!0,this.onConnect=()=>{aq.ConnectionControllerUtil.onConnectMobile(this.wallet)},!this.wallet)throw Error("w3m-connecting-wc-mobile: No wallet provided");this.secondaryBtnLabel="Open",this.secondaryLabel=ar.ConstantsUtil.CONNECT_LABELS.MOBILE,this.secondaryBtnIcon="externalLink",this.onHandleURI(),this.unsubscribe.push(n.ConnectionController.subscribeKey("wcUri",()=>{this.onHandleURI()})),p.EventsController.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"mobile",displayIndex:this.wallet?.display_index,walletRank:this.wallet.order,view:q.RouterController.state.view}})}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.btnLabelTimeout)}onHandleURI(){this.isLoading=!this.uri,!this.ready&&this.uri&&(this.ready=!0,this.onConnect?.())}onTryAgain(){n.ConnectionController.setWcError(!1),this.onConnect?.()}};as([(0,d.state)()],at.prototype,"redirectDeeplink",void 0),as([(0,d.state)()],at.prototype,"redirectUniversalLink",void 0),as([(0,d.state)()],at.prototype,"target",void 0),as([(0,d.state)()],at.prototype,"preferUniversalLinks",void 0),as([(0,d.state)()],at.prototype,"isLoading",void 0),at=as([(0,i.customElement)("w3m-connecting-wc-mobile")],at);var au=b;a.i(90030);var av=a.i(29529);function aw(a,b,c){return a!==b&&(a-b<0?b-a:a-b)<=c+.1}let ax={generate({uri:a,size:b,logoSize:d,padding:e=8,dotColor:f="var(--apkt-colors-black)"}){let g,h,i=[],j=(h=Math.sqrt((g=Array.prototype.slice.call(av.default.create(a,{errorCorrectionLevel:"Q"}).modules.data,0)).length),g.reduce((a,b,c)=>(c%h==0?a.push([b]):a[a.length-1].push(b))&&a,[])),k=(b-2*e)/j.length,l=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];l.forEach(({x:a,y:b})=>{let d=(j.length-7)*k*a+e,g=(j.length-7)*k*b+e;for(let a=0;a<l.length;a+=1){let b=k*(7-2*a);i.push(c.svg`
            <rect
...
`;var az=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aA=class extends au.LitElement{constructor(){super(...arguments),this.uri="",this.size=500,this.theme="dark",this.imageSrc=void 0,this.alt=void 0,this.arenaClear=void 0,this.farcaster=void 0}render(){return this.dataset.theme=this.theme,this.dataset.clear=String(this.arenaClear),c.html`<wui-flex
      alignItems="center"
    ...
    >
      ...
      <svg viewBox="0 0 ${this.size} ${this.size}" width="100%" height="100%">
        ${ax.generate({uri:this.uri,size:this.size,logoSize:this.arenaClear?0:this.size/4})}
      </svg>
    `}templateVisual(){return this.imageSrc?c.html`<wui-image src=${this.imageSrc} alt=${this.alt??"logo"}></wui-image>`:this.farcaster?c.html`<wui-icon
        ...
        color="inherit"
        name="farcaster"
      ></wui-icon>`:c.html`<wui-icon size="inherit" color="inherit" name="walletConnect"></wui-icon>`}};aA.styles=[M.resetStyles,ay],az([(0,k.property)()],aA.prototype,"uri",void 0),az([(0,k.property)({type:Number})],aA.prototype,"size",void 0),az([(0,k.property)()],aA.prototype,"theme",void 0),az([(0,k.property)()],aA.prototype,"imageSrc",void 0),az([(0,k.property)()],aA.prototype,"alt",void 0),az([(0,k.property)({type:Boolean})],aA.prototype,"arenaClear",void 0),az([(0,k.property)({type:Boolean})],aA.prototype,"farcaster",void 0),aA=az([(0,i.customElement)("wui-qr-code")],aA),a.i(53366),a.i(31093);let aB=z.css`
  wui-shimmer {
    width: 100%;
    aspect-ratio: 1 / 1;
    border-radius: ${({borderRadius:a})=>a[4]};
...
`;var aC=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aD=class extends an{constructor(){super(),this.basic=!1}firstUpdated(){this.basic||p.EventsController.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet?.name??"WalletConnect",platform:"qrcode",displayIndex:this.wallet?.display_index,walletRank:this.wallet?.order,view:q.RouterController.state.view}})}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.forEach(a=>a())}render(){return this.onRenderProxy(),c.html`
      <wui-flex
        flexDirection="column"
        alignItems="center"
        .padding=${["0","5","5","5"]}
    ...
    `}onRenderProxy(){!this.ready&&this.uri&&(this.ready=!0)}qrCodeTemplate(){if(!this.uri||!this.ready)return null;let a=this.wallet?this.wallet.name:void 0;n.ConnectionController.setWcLinking(void 0),n.ConnectionController.setRecentWallet(this.wallet);let b=Z.ThemeController.state.themeVariables["--apkt-qr-color"]??Z.ThemeController.state.themeVariables["--w3m-qr-color"];return c.html` <wui-qr-code
      theme=${Z.ThemeController.state.themeMode}
      uri=${this.uri}
      imageSrc=${(0,l.ifDefined)(v.AssetUtil.getWalletImage(this.wallet))}
      color=${(0,l.ifDefined)(b)}
      alt=${(0,l.ifDefined)(a)}
    ...
    >
    ...
    </wui-button>`}};aD.styles=aB,aC([(0,k.property)({type:Boolean})],aD.prototype,"basic",void 0),aD=aC([(0,i.customElement)("w3m-connecting-wc-qrcode")],aD);var aE=b;let aF=class extends aE.LitElement{constructor(){if(super(),this.wallet=q.RouterController.state.data?.wallet,!this.wallet)throw Error("w3m-connecting-wc-unsupported: No wallet provided");p.EventsController.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"browser",displayIndex:this.wallet?.display_index,walletRank:this.wallet?.order,view:q.RouterController.state.view}})}render(){return c.html`
      <wui-flex
        flexDirection="column"
        alignItems="center"
        .padding=${["10","5","5","5"]}
      ...
      <w3m-mobile-download-links .wallet=${this.wallet}></w3m-mobile-download-links>
    `}};aF=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g}([(0,i.customElement)("w3m-connecting-wc-unsupported")],aF);var aG=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aH=class extends an{constructor(){if(super(),this.isLoading=!0,!this.wallet)throw Error("w3m-connecting-wc-web: No wallet provided");this.onConnect=this.onConnectProxy.bind(this),this.secondaryBtnLabel="Open",this.secondaryLabel=ar.ConstantsUtil.CONNECT_LABELS.MOBILE,this.secondaryBtnIcon="externalLink",this.updateLoadingState(),this.unsubscribe.push(n.ConnectionController.subscribeKey("wcUri",()=>{this.updateLoadingState()})),p.EventsController.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"web",displayIndex:this.wallet?.display_index,walletRank:this.wallet?.order,view:q.RouterController.state.view}})}updateLoadingState(){this.isLoading=!this.uri}onConnectProxy(){if(this.wallet?.webapp_link&&this.uri)try{this.error=!1;let{webapp_link:a,name:b}=this.wallet,{redirect:c,href:d}=f.CoreHelperUtil.formatUniversalUrl(a,this.uri);n.ConnectionController.setWcLinking({name:b,href:d}),n.ConnectionController.setRecentWallet(this.wallet),f.CoreHelperUtil.openHref(c,"_blank")}catch{this.error=!0}}};aG([(0,d.state)()],aH.prototype,"isLoading",void 0),aH=aG([(0,i.customElement)("w3m-connecting-wc-web")],aH);let aI=z.css`
...
`;var aJ=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aK=class extends D.LitElement{constructor(){super(),this.wallet=q.RouterController.state.data?.wallet,this.unsubscribe=[],this.platform=void 0,this.platforms=[],this.isSiwxEnabled=!!g.OptionsController.state.siwx,this.remoteFeatures=g.OptionsController.state.remoteFeatures,this.displayBranding=!0,this.basic=!1,this.determinePlatforms(),this.initializeConnection(),this.unsubscribe.push(g.OptionsController.subscribeKey("remoteFeatures",a=>this.remoteFeatures=a))}disconnectedCallback(){this.unsubscribe.forEach(a=>a())}render(){return g.OptionsController.state.enableMobileFullScreen&&this.setAttribute("data-mobile-fullscreen","true"),c.html`
      ${this.headerTemplate()}
      <div class="platform-container">${this.platformTemplate()}</div>
      ${this.reownBrandingTemplate()}
    `}reownBrandingTemplate(){return this.remoteFeatures?.reownBranding&&this.displayBranding?c.html`<wui-ux-by-reown></wui-ux-by-reown>`:null}async initializeConnection(a=!1){if("browser"!==this.platform&&(!g.OptionsController.state.manualWCControl||a))try{let{wcPairingExpiry:b,status:c}=n.ConnectionController.state,{redirectView:d}=q.RouterController.state.data??{};if(a||g.OptionsController.state.enableEmbedded||f.CoreHelperUtil.isPairingExpired(b)||"connecting"===c){let a=n.ConnectionController.getConnections(w.ChainController.state.activeChain),b=this.remoteFeatures?.multiWallet,c=a.length>0;await n.ConnectionController.connectWalletConnect({cache:"never"}),this.isSiwxEnabled||(c&&b?(q.RouterController.replace("ProfileWallets"),I.SnackController.showSuccess("New Wallet Added")):d?q.RouterController.replace(d):H.ModalController.close())}}catch(a){if(a instanceof Error&&a.message.includes("An error occurred when attempting to switch chain")&&!g.OptionsController.state.enableNetworkSwitch&&w.ChainController.state.activeChain){w.ChainController.setActiveCaipNetwork(J.CaipNetworksUtil.getUnsupportedNetwork(`${w.ChainController.state.activeChain}:${w.ChainController.state.activeCaipNetwork?.id}`)),w.ChainController.showUnsupportedChainUI();return}a instanceof F.AppKitError&&a.originalName===E.ErrorUtil.PROVIDER_RPC_ERROR_NAME.USER_REJECTED_REQUEST?p.EventsController.sendEvent({type:"track",event:"USER_REJECTED",properties:{message:a.message}}):p.EventsController.sendEvent({type:"track",event:"CONNECT_ERROR",properties:{message:a?.message??"Unknown"}}),n.ConnectionController.setWcError(!0),I.SnackController.showError(a.message??"Connection error"),n.ConnectionController.resetWcConnection(),q.RouterController.goBack()}}determinePlatforms(){if(!this.wallet){this.platforms.push("qrcode"),this.platform="qrcode";return}if(this.platform)return;let{mobile_link:a,desktop_link:b,webapp_link:c,injected:d,rdns:e}=this.wallet,h=d?.map(({injected_id:a})=>a).filter(Boolean),i=[...e?[e]:h??[]],j=!g.OptionsController.state.isUniversalProvider&&i.length,k=n.ConnectionController.checkInstalled(i),l=j&&k,m=b&&!f.CoreHelperUtil.isMobile();l&&!w.ChainController.state.noAdapters&&this.platforms.push("browser"),a&&this.platforms.push(f.CoreHelperUtil.isMobile()?"mobile":"qrcode"),c&&this.platforms.push("web"),m&&this.platforms.push("desktop");let o=G.MobileWalletUtil.isCustomDeeplinkWallet(this.wallet.id,w.ChainController.state.activeChain);l||!j||w.ChainController.state.noAdapters||o||this.platforms.push("unsupported"),this.platform=this.platforms[0]}platformTemplate(){switch(this.platform){case"browser":return c.html`<w3m-connecting-wc-browser></w3m-connecting-wc-browser>`;case"web":return c.html`<w3m-connecting-wc-web></w3m-connecting-wc-web>`;case"desktop":return c.html`
    ...
    `:null}async onSelectPlatform(a){let b=this.shadowRoot?.querySelector("div");b&&(await b.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.platform=a,b.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"}))}};aK.styles=aI,aJ([(0,d.state)()],aK.prototype,"platform",void 0),aJ([(0,d.state)()],aK.prototype,"platforms",void 0),aJ([(0,d.state)()],aK.prototype,"isSiwxEnabled",void 0),aJ([(0,d.state)()],aK.prototype,"remoteFeatures",void 0),aJ([(0,k.property)({type:Boolean})],aK.prototype,"displayBranding",void 0),aJ([(0,k.property)({type:Boolean})],aK.prototype,"basic",void 0),aK=aJ([(0,i.customElement)("w3m-connecting-wc-view")],aK);var aL=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aM=class extends b.LitElement{constructor(){super(),this.unsubscribe=[],this.isMobile=f.CoreHelperUtil.isMobile(),this.remoteFeatures=g.OptionsController.state.remoteFeatures,this.unsubscribe.push(g.OptionsController.subscribeKey("remoteFeatures",a=>this.remoteFeatures=a))}disconnectedCallback(){this.unsubscribe.forEach(a=>a())}render(){if(this.isMobile){let{featured:a,recommended:b}=e.ApiController.state,{customWallets:d}=g.OptionsController.state,f=h.StorageUtil.getRecentWallets(),i=a.length||b.length||d?.length||f.length;return c.html`<wui-flex flexDirection="column" gap="2" .margin=${["1","3","3","3"]}>
    ...
    </wui-flex>`:null}};aL([(0,d.state)()],aM.prototype,"isMobile",void 0),aL([(0,d.state)()],aM.prototype,"remoteFeatures",void 0),aM=aL([(0,i.customElement)("w3m-connecting-wc-basic-view")],aM),a.s(["W3mConnectingWcBasicView",0,aM],43601);var aN=b,aO=b,aP=b;let{I:aQ}=c._$LH;var aR=a.i(22107);let aS=(a,b)=>{let c=a._$AN;if(void 0===c)return!1;for(let a of c)a._$AO?.(b,!1),aS(a,b);return!0},aT=a=>{let b,c;do{if(void 0===(b=a._$AM))break;(c=b._$AN).delete(a),a=b}while(0===c?.size)},aU=a=>{for(let b;b=a._$AM;a=b){let c=b._$AN;if(void 0===c)b._$AN=c=new Set;else if(c.has(a))break;c.add(a),aX(b)}};function aV(a){void 0!==this._$AN?(aT(this),this._$AM=a,aU(this)):this._$AM=a}function aW(a,b=!1,c=0){let d=this._$AH,e=this._$AN;if(void 0!==e&&0!==e.size)if(b)if(Array.isArray(d))for(let a=c;a<d.length;a++)aS(d[a],!1),aT(d[a]);else null!=d&&(aS(d,!1),aT(d));else aS(this,a)}let aX=a=>{a.type==aR.PartType.CHILD&&(a._$AP??=aW,a._$AQ??=aV)};class aY extends aR.Directive{constructor(){super(...arguments),this._$AN=void 0}_$AT(a,b,c){super._$AT(a,b,c),aU(this),this.isConnected=a._$AU}_$AO(a,b=!0){a!==this.isConnected&&(this.isConnected=a,a?this.reconnected?.():this.disconnected?.()),b&&(aS(this,a),aT(this))}setValue(a){if(void 0===this._$Ct.strings)this._$Ct._$AI(a,this);else{let b=[...this._$Ct._$AH];b[this._$Ci]=a,this._$Ct._$AI(b,this,0)}}disconnected(){}reconnected(){}}let aZ=()=>new a$;class a${}let a_=new WeakMap,a0=(0,aR.directive)(class extends aY{render(a){return c.nothing}update(a,[b]){let d=b!==this.G;return d&&this.rt(void 0),(d||this.lt!==this.ct)&&(this.G=b,this.ht=a.options?.host,this.rt(this.ct=a.element)),c.nothing}rt(a){if(void 0!==this.G)if(this.isConnected||(a=void 0),"function"==typeof this.G){let b=this.ht??globalThis,c=a_.get(b);void 0===c&&(c=new WeakMap,a_.set(b,c)),void 0!==c.get(this.G)&&this.G.call(this.ht,void 0),c.set(this.G,a),void 0!==a&&this.G.call(this.ht,a)}else this.G.value=a}get lt(){return"function"==typeof this.G?a_.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),a1=z.css`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
...
`;var a2=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let a3=class extends aP.LitElement{constructor(){super(...arguments),this.inputElementRef=aZ(),this.checked=!1,this.disabled=!1,this.size="md"}render(){return c.html`
      <label data-size=${this.size}>
        <input
          ${a0(this.inputElementRef)}
          type="checkbox"
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent("switchChange",{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};a3.styles=[M.resetStyles,M.elementStyles,a1],a2([(0,k.property)({type:Boolean})],a3.prototype,"checked",void 0),a2([(0,k.property)({type:Boolean})],a3.prototype,"disabled",void 0),a2([(0,k.property)()],a3.prototype,"size",void 0),a3=a2([(0,i.customElement)("wui-toggle")],a3);let a4=z.css`
  :host {
    height: auto;
  }
...
`;var a5=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let a6=class extends aO.LitElement{constructor(){super(...arguments),this.checked=!1}render(){return c.html`
      <wui-flex>
    ...
    `}handleToggleChange(a){a.stopPropagation(),this.checked=a.detail,this.dispatchSwitchEvent()}dispatchSwitchEvent(){this.dispatchEvent(new CustomEvent("certifiedSwitchChange",{detail:this.checked,bubbles:!0,composed:!0}))}};a6.styles=[M.resetStyles,M.elementStyles,a4],a5([(0,k.property)({type:Boolean})],a6.prototype,"checked",void 0),a6=a5([(0,i.customElement)("wui-certified-switch")],a6);var a7=b,a8=b;let a9=z.css`
  :host {
    position: relative;
    width: 100%;
    display: inline-flex;
...
`;var ba=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bb=class extends a8.LitElement{constructor(){super(...arguments),this.inputElementRef=aZ(),this.disabled=!1,this.loading=!1,this.placeholder="",this.type="text",this.value="",this.size="md"}render(){return c.html` <div class="wui-input-text-container">
      ...
      </button>`:null}templateError(){return this.errorText?c.html`<wui-text variant="sm-regular" color="error">${this.errorText}</wui-text>`:null}templateWarning(){return this.warningText?c.html`<wui-text variant="sm-regular" color="warning">${this.warningText}</wui-text>`:null}dispatchInputChangeEvent(){this.dispatchEvent(new CustomEvent("inputChange",{detail:this.inputElementRef.value?.value,bubbles:!0,composed:!0}))}};bb.styles=[M.resetStyles,M.elementStyles,a9],ba([(0,k.property)()],bb.prototype,"icon",void 0),ba([(0,k.property)({type:Boolean})],bb.prototype,"disabled",void 0),ba([(0,k.property)({type:Boolean})],bb.prototype,"loading",void 0),ba([(0,k.property)()],bb.prototype,"placeholder",void 0),ba([(0,k.property)()],bb.prototype,"type",void 0),ba([(0,k.property)()],bb.prototype,"value",void 0),ba([(0,k.property)()],bb.prototype,"errorText",void 0),ba([(0,k.property)()],bb.prototype,"warningText",void 0),ba([(0,k.property)()],bb.prototype,"onSubmit",void 0),ba([(0,k.property)()],bb.prototype,"size",void 0),ba([(0,k.property)({attribute:!1})],bb.prototype,"onKeyDown",void 0),bb=ba([(0,i.customElement)("wui-input-text")],bb);let bc=z.css`
  :host {
    position: relative;
    display: inline-block;
    width: 100%;
...
`;var bd=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let be=class extends a7.LitElement{constructor(){super(...arguments),this.inputComponentRef=aZ(),this.inputValue=""}render(){return c.html`
      <wui-input-text
        ${a0(this.inputComponentRef)}
    ...
    `}onInputChange(a){this.inputValue=a.detail||""}clearValue(){let a=this.inputComponentRef.value,b=a?.inputElementRef.value;b&&(b.value="",this.inputValue="",b.focus(),b.dispatchEvent(new Event("input")))}};be.styles=[M.resetStyles,bc],bd([(0,k.property)()],be.prototype,"inputValue",void 0),be=bd([(0,i.customElement)("wui-search-bar")],be);var bf=b,bg=a.i(24667),bh=b,bi=a.i(17014);a.i(47130);let bj=z.css`
  :host {
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`;var bk=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bl=class extends bh.LitElement{constructor(){super(...arguments),this.type="wallet"}render(){return c.html`
    ...
    `}shimmerTemplate(){return"network"===this.type?c.html` <wui-shimmer data-type=${this.type} width="48px" height="54px"></wui-shimmer>
        ${bi.networkSvgMd}`:c.html`<wui-shimmer width="56px" height="56px"></wui-shimmer>`}};bl.styles=[M.resetStyles,M.elementStyles,bj],bk([(0,k.property)()],bl.prototype,"type",void 0),bl=bk([(0,i.customElement)("wui-card-select-loader")],bl);var bm=b,bn=a.i(26311);let bo=bn.css`
  :host {
    display: grid;
    width: inherit;
    height: inherit;
  }
`;var bp=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bq=class extends bm.LitElement{render(){return this.style.cssText=`
      ...
      padding-top: ${this.padding&&ad.UiHelperUtil.getSpacingStyles(this.padding,0)};
      padding-right: ${this.padding&&ad.UiHelperUtil.getSpacingStyles(this.padding,1)};
      padding-bottom: ${this.padding&&ad.UiHelperUtil.getSpacingStyles(this.padding,2)};
      padding-left: ${this.padding&&ad.UiHelperUtil.getSpacingStyles(this.padding,3)};
      margin-top: ${this.margin&&ad.UiHelperUtil.getSpacingStyles(this.margin,0)};
      margin-right: ${this.margin&&ad.UiHelperUtil.getSpacingStyles(this.margin,1)};
      margin-bottom: ${this.margin&&ad.UiHelperUtil.getSpacingStyles(this.margin,2)};
      margin-left: ${this.margin&&ad.UiHelperUtil.getSpacingStyles(this.margin,3)};
    `,c.html`<slot></slot>`}};bq.styles=[M.resetStyles,bo],bp([(0,k.property)()],bq.prototype,"gridTemplateRows",void 0),bp([(0,k.property)()],bq.prototype,"gridTemplateColumns",void 0),bp([(0,k.property)()],bq.prototype,"justifyItems",void 0),bp([(0,k.property)()],bq.prototype,"alignItems",void 0),bp([(0,k.property)()],bq.prototype,"justifyContent",void 0),bp([(0,k.property)()],bq.prototype,"alignContent",void 0),bp([(0,k.property)()],bq.prototype,"columnGap",void 0),bp([(0,k.property)()],bq.prototype,"rowGap",void 0),bp([(0,k.property)()],bq.prototype,"gap",void 0),bp([(0,k.property)()],bq.prototype,"padding",void 0),bp([(0,k.property)()],bq.prototype,"margin",void 0),bq=bp([(0,i.customElement)("wui-grid")],bq);var br=b;let bs=z.css`
  button {
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`;var bt=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bu=class extends br.LitElement{constructor(){super(),this.observer=new IntersectionObserver(()=>void 0),this.visible=!1,this.imageSrc=void 0,this.imageLoading=!1,this.isImpressed=!1,this.explorerId="",this.walletQuery="",this.certified=!1,this.displayIndex=0,this.wallet=void 0,this.observer=new IntersectionObserver(a=>{a.forEach(a=>{a.isIntersecting?(this.visible=!0,this.fetchImageSrc(),this.sendImpressionEvent()):this.visible=!1})},{threshold:.01})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){let a=this.wallet?.badge_type==="certified";return c.html`
      <button>
        ${this.imageTemplate()}
    ...
    `:this.shimmerTemplate()}shimmerTemplate(){return c.html`<wui-shimmer width="56px" height="56px"></wui-shimmer>`}async fetchImageSrc(){!this.wallet||(this.imageSrc=v.AssetUtil.getWalletImage(this.wallet),this.imageSrc||(this.imageLoading=!0,this.imageSrc=await v.AssetUtil.fetchWalletImage(this.wallet.image_id),this.imageLoading=!1))}sendImpressionEvent(){this.wallet&&!this.isImpressed&&(this.isImpressed=!0,p.EventsController.sendWalletImpressionEvent({name:this.wallet.name,walletRank:this.wallet.order,explorerId:this.explorerId,view:q.RouterController.state.view,query:this.walletQuery,certified:this.certified,displayIndex:this.displayIndex}))}};bu.styles=bs,bt([(0,d.state)()],bu.prototype,"visible",void 0),bt([(0,d.state)()],bu.prototype,"imageSrc",void 0),bt([(0,d.state)()],bu.prototype,"imageLoading",void 0),bt([(0,d.state)()],bu.prototype,"isImpressed",void 0),bt([(0,k.property)()],bu.prototype,"explorerId",void 0),bt([(0,k.property)()],bu.prototype,"walletQuery",void 0),bt([(0,k.property)()],bu.prototype,"certified",void 0),bt([(0,k.property)()],bu.prototype,"displayIndex",void 0),bt([(0,k.property)({type:Object})],bu.prototype,"wallet",void 0),bu=bt([(0,i.customElement)("w3m-all-wallets-list-item")],bu);let bv=z.css`
  wui-grid {
...
`;var bw=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bx="local-paginator",by=class extends bf.LitElement{constructor(){super(),this.unsubscribe=[],this.paginationObserver=void 0,this.loading=!e.ApiController.state.wallets.length,this.wallets=e.ApiController.state.wallets,this.mobileFullScreen=g.OptionsController.state.enableMobileFullScreen,this.unsubscribe.push(e.ApiController.subscribeKey("wallets",a=>this.wallets=a))}firstUpdated(){this.initialFetch(),this.createPaginationObserver()}disconnectedCallback(){this.unsubscribe.forEach(a=>a()),this.paginationObserver?.disconnect()}render(){return this.mobileFullScreen&&this.setAttribute("data-mobile-fullscreen","true"),c.html`
      <wui-grid
    ...
    `}async initialFetch(){this.loading=!0;let a=this.shadowRoot?.querySelector("wui-grid");a&&(await e.ApiController.fetchWalletsByPage({page:1}),await a.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.loading=!1,a.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"}))}shimmerTemplate(a,b){return[...Array(a)].map(()=>c.html`
      ...
      `)}walletsTemplate(){return bg.WalletUtil.getWalletConnectWallets(this.wallets).map((a,b)=>c.html`
        <w3m-all-wallets-list-item
          ...
          displayIndex=${b}
        ></w3m-all-wallets-list-item>
      `)}paginationLoaderTemplate(){let{wallets:a,recommended:b,featured:c,count:d,mobileFilteredOutWalletsLength:f}=e.ApiController.state,g=window.innerWidth<352?3:4,h=a.length+b.length,i=Math.ceil(h/g)*g-h+g;return(i-=a.length?c.length%g:0,0===d&&c.length>0)?null:0===d||[...c,...a,...b].length<d-(f??0)?this.shimmerTemplate(i,bx):null}createPaginationObserver(){let a=this.shadowRoot?.querySelector(`#${bx}`);a&&(this.paginationObserver=new IntersectionObserver(([a])=>{if(a?.isIntersecting&&!this.loading){let{page:a,count:b,wallets:c}=e.ApiController.state;c.length<b&&e.ApiController.fetchWalletsByPage({page:a+1})}}),this.paginationObserver.observe(a))}onConnectWallet(a){o.ConnectorController.selectWalletConnector(a)}};by.styles=bv,bw([(0,d.state)()],by.prototype,"loading",void 0),bw([(0,d.state)()],by.prototype,"wallets",void 0),bw([(0,d.state)()],by.prototype,"badge",void 0),bw([(0,d.state)()],by.prototype,"mobileFullScreen",void 0),by=bw([(0,i.customElement)("w3m-all-wallets-list")],by);var bz=b;a.i(31802);let bA=bn.css`
  wui-grid,
  wui-loading-spinner,
  wui-flex {
    height: 360px;
...
`;var bB=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bC=class extends bz.LitElement{constructor(){super(...arguments),this.prevQuery="",this.prevBadge=void 0,this.loading=!0,this.mobileFullScreen=g.OptionsController.state.enableMobileFullScreen,this.query=""}render(){return this.mobileFullScreen&&this.setAttribute("data-mobile-fullscreen","true"),this.onSearch(),this.loading?c.html`<wui-loading-spinner color="accent-primary"></wui-loading-spinner>`:this.walletsTemplate()}async onSearch(){(this.query.trim()!==this.prevQuery.trim()||this.badge!==this.prevBadge)&&(this.prevQuery=this.query,this.prevBadge=this.badge,this.loading=!0,await e.ApiController.searchWallet({search:this.query,badge:this.badge}),this.loading=!1)}walletsTemplate(){let{search:a}=e.ApiController.state,b=bg.WalletUtil.markWalletsAsInstalled(a),d=bg.WalletUtil.filterWalletsByWcSupport(b);return d.length?c.html`
      <wui-grid
    ...
    `:c.html`
      ...
      `}onConnectWallet(a){o.ConnectorController.selectWalletConnector(a)}};bC.styles=bA,bB([(0,d.state)()],bC.prototype,"loading",void 0),bB([(0,d.state)()],bC.prototype,"mobileFullScreen",void 0),bB([(0,k.property)()],bC.prototype,"query",void 0),bB([(0,k.property)()],bC.prototype,"badge",void 0),bC=bB([(0,i.customElement)("w3m-all-wallets-search")],bC);var bD=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bE=class extends aN.LitElement{constructor(){super(...arguments),this.search="",this.badge=void 0,this.onDebouncedSearch=f.CoreHelperUtil.debounce(a=>{this.search=a})}render(){let a=this.search.length>=2;return c.html`
    ...
    `}onInputChange(a){this.onDebouncedSearch(a.detail)}onCertifiedSwitchChange(a){a.detail?(this.badge="certified",I.SnackController.showSvg("Only WalletConnect certified",{icon:"walletConnectBrown",iconColor:"accent-100"})):this.badge=void 0}qrButtonTemplate(){return f.CoreHelperUtil.isMobile()?c.html`
        <wui-icon-box
          size="xl"
          iconSize="xl"
        ...
        ></wui-icon-box>
      `:null}onWalletConnectQr(){q.RouterController.push("ConnectingWalletConnect")}};bD([(0,d.state)()],bE.prototype,"search",void 0),bD([(0,d.state)()],bE.prototype,"badge",void 0),bE=bD([(0,i.customElement)("w3m-all-wallets-view")],bE),a.s(["W3mAllWalletsView",0,bE],77214);var bF=b;a.i(79536);let bG=class extends bF.LitElement{constructor(){super(...arguments),this.wallet=q.RouterController.state.data?.wallet}render(){if(!this.wallet)throw Error("w3m-downloads-view");return c.html`
    ...
    `:null}openStore(a){a.href&&this.wallet&&(p.EventsController.sendEvent({type:"track",event:"GET_WALLET",properties:{name:this.wallet.name,walletRank:this.wallet.order,explorerId:this.wallet.id,type:a.type}}),f.CoreHelperUtil.openHref(a.href,"_blank"))}onChromeStore(){this.wallet?.chrome_store&&this.openStore({href:this.wallet.chrome_store,type:"chrome_store"})}onAppStore(){this.wallet?.app_store&&this.openStore({href:this.wallet.app_store,type:"app_store"})}onPlayStore(){this.wallet?.play_store&&this.openStore({href:this.wallet.play_store,type:"play_store"})}onHomePage(){this.wallet?.homepage&&this.openStore({href:this.wallet.homepage,type:"homepage"})}};bG=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g}([(0,i.customElement)("w3m-downloads-view")],bG),a.s(["W3mDownloadsView",0,bG],90691),a.s([],39533),a.i(39533),a.i(43601),a.i(77214),a.i(90691),a.s(["W3mAllWalletsView",0,bE,"W3mConnectingWcBasicView",0,aM,"W3mDownloadsView",0,bG],20047)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__1kycvmw._.js.map